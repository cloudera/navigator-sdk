...
public abstract class Dataset extends SchemaElement {
  ...
  /**
   * Return data compression type, if any. For default compression types,
   * see {@link com.cloudera.nav.plugin.model.entities.DefaultCompressionTypes}
   */
  ...
  /**
   * Return file format information, if applicable. For default types,
   * see {@link com.cloudera.nav.plugin.model.entities.DefaultFileFormats}
   */
