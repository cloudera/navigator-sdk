...
public class StetsonScript extends Entity {
  ...
  private EndPointProxy operation;
  ...
  public void setOperation(String operationId, SourceType sourceType) {
    this.operation = new EndPointProxy(operationId, sourceType,
