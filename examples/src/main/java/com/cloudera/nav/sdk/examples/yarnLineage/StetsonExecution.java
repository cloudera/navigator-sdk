...
public class StetsonExecution extends Entity {
  ...
  public void setExecution(String executionId, SourceType sourceType) {
    this.execution = new EndPointProxy(executionId, sourceType,
